    ...
    <mu-dialog :open="dialogVisible" :title="$t('title')" dialogClass="model-tip ">
        <div class="main1" >
            <div class="two-img-wrapper">
                <div class="img1">
                    <img class="img" src="../assets/dialog/GroveMiniFanDialog/mini-fan01.png" />
                    <span>D8/9</span>
                </div>
                <div class="img1">
...
<script>
  ...
  module.exports = {
    ...
    i18n: {
      messages: {
        en: {
          title: 'Please connect MIni Fan with the D8/9 or Pin4 port',
          next: 'Next',
          close: 'Close',
          ok: 'Ok',
          cancel: 'Cancel',
