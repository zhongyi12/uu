    ...
    <mu-dialog :open="dialogVisible" :title="$t('title')" dialogClass="model-tip ">
        <div class="main1" >
            <div class="two-img-wrapper">
                ...
                <!--</div>-->
                <div class="img1">
                    <img class="img" src="../assets/dialog/GroveButtonDialog/button_pin3_4_5.png" />
                    <!--<span>Pin3/4/5</span>-->
                </div>
            </div>
...
<script>
  ...
  module.exports = {
    ...
    i18n: {
      messages: {
        en: {
          title: 'Please connect Button with Pin3/4/5 port',
          next: 'Next',
          close: 'Close',
          ok: 'Ok',
          cancel: 'Cancel',
