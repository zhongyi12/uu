    ...
    <mu-dialog :open="dialogVisible" :title="$t('title')" dialogClass="model-tip ">
        <div class="main1" >
            <div class="two-img-wrapper">
                <!--<div class="img1">-->
                    <!--<img class="img" src="../assets/dialog/GroveLightDialog/light_sensor_a13.png" />-->
                    <!--<span>A13</span>-->
                <!--</div>-->
                <div class="img1">
                    <img class="img" src="../assets/dialog/GroveLightDialog/light_sensor_pin1_2.png" />
                    <!--<span>Pin1/2</span>-->
                </div>
            </div>
...
<script>
  ...
  module.exports = {
    ...
    i18n: {
      messages: {
        en: {
          title: 'Please connect Light Sensor with Pin1/2 Port',
          next: 'Next',
          close: 'Close',
          ok: 'Ok',
          cancel: 'Cancel',
