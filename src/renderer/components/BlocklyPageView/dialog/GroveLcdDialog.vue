    ...
    <mu-dialog :open="dialogVisible" :title="$t('title')" dialogClass="model-tip ">
        <div class="main1" >
            <div class="img-wrapper-com img-wrapper">
                <img class="img" src="../assets/dialog/GroveLcdDialog/lcd.png" />
            </div>
...
<script>
  ...
  module.exports = {
    ...
    i18n: {
      messages: {
        en: {
          title: 'Please connect LCD RGB Backlight with the base of uArm',
          next: 'Next',
          close: 'Close',
          ok: 'Ok',
          cancel: 'Cancel',
    ...
    data() {
      return {
        blockNames: [
          'control_grove_lcd_display',
          'control_grove_lcd_display_clear',
        ],
        dialogVisible: false,
        dontShowAgain: false,
      };
