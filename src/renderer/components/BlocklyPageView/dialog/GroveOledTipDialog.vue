    ...
    <mu-dialog :open="dialogVisible" :title="$t('title')" dialogClass="model-tip">
        <div class="main1" >
            <div class="img-wrapper-com img-wrapper">
                <img class="img" src="../assets/dialog/GroveOledDialog/oled_display.png" />
            </div>
...
<script>
  ...
  module.exports = {
    ...
    i18n: {
      messages: {
        en: {
          title: 'Please connect OLED Display with base of uArm',
          next: 'Next',
          close: 'Close',
          ok: 'Ok',
          cancel: 'Cancel',
